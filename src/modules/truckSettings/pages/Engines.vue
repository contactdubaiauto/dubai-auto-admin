<template>
  <div class="h-full flex flex-col">
    <div class="flex flex-col gap-4 p-4 border-b-2 border-gray-100 mb-2">
      <div class="flex justify-between w-full">
        <Button @click="openPopUpEngine" icon="pi pi-plus" :label="t('truckSettings.engine.add')" />
      </div>
      <div class="flex">
    ...
    <div class="flex-1 overflow-y-auto">
      <DataTable :value="engines" :loading="loadingEngines" stripedRows rowHover size="small">
        ...
        <Column :header="t('truckSettings.engine.name')">
  ...
  <PopUpConfirmDelete
    ...
    :description="t('truckSettings.engine.confirmDelete')"
  />
</template>
...
<script setup lang="ts">
  ...
  const breadcrumbs = computed(() => [
    ...
    { label: t('truckSettings.engine.title'), to: '/truck-settings/engines' }
  ])
