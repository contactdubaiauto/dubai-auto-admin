<template>
	<div class="h-full flex flex-col">
		<div class="flex justify-between p-4 border-b-2 border-gray-100 mb-2">
			<Button @click="openPopUpCategory" icon="pi pi-plus" :label="t('truckSettings.category.add')" />
		</div>
	...
	<PopUpConfirmDelete v-if="showPopUpDeleteCategory" @delete="deleteCategory" @cancel="closePopUpDeleteCategory"
		:loading="loadingPopUpDeleteCategory" :description="t('truckSettings.category.confirmDelete')" />
</template>
