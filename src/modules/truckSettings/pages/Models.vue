<template>
	<div class="h-full flex flex-col">
		<div class="flex flex-col gap-4 p-4 border-b-2 border-gray-100 mb-2">
			<div class="flex justify-between w-full">
				<Button @click="openPopUpModel" icon="pi pi-plus" :label="t('truckSettings.model.add')" />
			</div>
			<div class="flex">
	...
	<PopUpConfirmDelete v-if="showPopUpDeleteModel" @delete="deleteModel" @cancel="closePopUpDeleteModel"
		:loading="loadingPopUpDeleteModel" :description="t('truckSettings.model.confirmDelete')" />
</template>
...
<script setup lang="ts">
	...
	const breadcrumbs = computed(() => [
		...
		{ label: t('truckSettings.brand.title'), to: '/truck-settings/brands' },
		{ label: t('truckSettings.model.models'), to: `/truck-settings/brand/${brandId}/models` }
	])
