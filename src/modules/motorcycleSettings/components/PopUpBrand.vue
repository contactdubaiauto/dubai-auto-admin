<template>
	<Dialog :visible="true" modal :header="t('motorcycleSettings.brand.title')" :style="{ width: '25rem' }"
		@update:visible="cancel">
		<Form v-slot="$form" :initialValues="form" :resolver="resolver" :validateOnBlur="true" @submit="onFormSubmit">
			<div class="flex gap-4">
				<div class="flex flex-col items-center gap-2">
					<FileUpload mode="basic" @select="onFileSelect" customUpload auto :chooseLabel="t('base.choose')"
						accept="image/*" class="p-button-outlined" :disabled="loading" />
