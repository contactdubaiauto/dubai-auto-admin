<template>
	<div class="flex justify-center items-center h-screen">
		<Form v-slot="$form" :initialValues="initialValues" :resolver="resolver" :validateOnValueUpdate="false"
			:validateOnBlur="true" @submit="onFormSubmit" class="flex flex-col gap-4 w-full sm:w-80">
			<div class="flex items-center gap-2 mb-4 justify-center">
				<img src="/logo.png" alt="OfferCars" class="w-8 h-8 object-contain object-center" />
				<div class="text-2xl font-bold text-blue-500">OfferCars</div>
			</div>
